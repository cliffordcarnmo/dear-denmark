...
static Triangle2 Triangles[7];

extern unsigned char greets;
extern unsigned int greets_len;
...
void greetsEnter(){
	...
	logo = loadTextureFromMemory(&greets, greets_len);
...
void greetsUpdate(float frameTime){
