...
#define BASS_ERROR_FILEOPEN	2	// cant open the file
#define BASS_ERROR_DRIVER	3	// cant find a free/valid driver
...
#define BASS_MUSIC_NOSAMPLE	0x400000// dont load the samples
...
typedef void (CALLBACK SYNCPROC)(DWORD handle, DWORD data, DWORD user);
...
DWORD BASSDEF(BASSMOD_MusicSetSync)(DWORD type, DWORD param, SYNCPROC *proc, DWORD user);
BOOL BASSDEF(BASSMOD_MusicRemoveSync)(DWORD sync);
